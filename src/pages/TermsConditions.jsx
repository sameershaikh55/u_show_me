...
const TermsConditions = () => {
	...
	const [dataHome, setDataHome] = useState(data[0].EN.terms);

	useEffect(() => {
		if (Lang === "EN") {
			setDataHome(data[0].EN.terms);
		} else if (Lang === "ES") {
			setDataHome(data[0].ES.terms);
		} else if (Lang === "PT") {
			setDataHome(data[0].PT.terms);
		}
	}, [dataHome, Lang]);
